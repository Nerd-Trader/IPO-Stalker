...
enum IpoRegion {
    IPO_REGION_COUNTRY_BELGIUM,
    IPO_REGION_COUNTRY_FRANCE,
    IPO_REGION_COUNTRY_IRELAND,
    IPO_REGION_COUNTRY_ITALY,
    IPO_REGION_COUNTRY_JAPAN,
    IPO_REGION_COUNTRY_NETHERLANDS,
    IPO_REGION_COUNTRY_NORWAY,
    IPO_REGION_COUNTRY_PORTUGAL,
    IPO_REGION_COUNTRY_UK,
